...
import com.lyf.common.constant.ScheduleConstants;
import com.lyf.common.exception.job.TaskException;
import com.lyf.common.exception.job.TaskException.Code;
...
public class ScheduleUtils
{
    ...
    public static CronTrigger getCronTrigger(Scheduler scheduler, Long jobId)
    {
        try
        {
            TriggerKey trigger = getTriggerKey(jobId);
            System.out.println("trigger.getClass().getName():"+trigger.getClass().getName());
            return (CronTrigger) scheduler.getTrigger(trigger);
        }
